...
def main():
    ...
    patterns = [
        ...
        ("GUI_BindChildStructByName", metric_pattern("GUI_BindChildStructByName")),
        ("GUI_BaseControlSetup", metric_pattern("GUI_BaseControlSetup")),
        ("GUI_CommonBaseBinder", metric_pattern("GUI_CommonBaseBinder")),
        ("GUI_ListBoxBindProtoItem", metric_pattern("GUI_ListBoxBindProtoItem")),
        ("GFF_ReadBoolFieldByName", metric_pattern("GFF_ReadBoolFieldByName")),
        ("GFF_ReadIntFieldByName", metric_pattern("GFF_ReadIntFieldByName")),
        ("GFF_ReadVector3FieldByName", metric_pattern("GFF_ReadVector3FieldByName")),
        ("GFF_LookupFieldLabelByName", metric_pattern("GFF_LookupFieldLabelByName")),
